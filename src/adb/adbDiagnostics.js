 ...
 */
// Os predicados de serial sem fio moram em `serial.js` — módulo puro, sem
// dependências, para que `adb.js` também os use sem arrastar o i18n daqui.
// Reexportados no fim deste arquivo por conveniência de quem já os importava.
const { ehSemFio, killServerDestroi } = require('./serial.js');
