...
o Projectivy Launcher) foi REMOVIDO do Revya. Motivo: REDISTRIBUIR o APK
...
grátis também é distribuição. Quando o Revya passou a ser gratuito, a
redação antiga sugeria que a regra tinha caído. Não caiu. Cobrar nunca foi a
parte que importava.

O Revya faz a transformação do celular; os aplicativos que o usuário quiser
...
Os arquivos que estavam aqui foram movidos para fora do projeto, em
  /Users/natalierjunior/revya-apks-removidos/

Estrutura atual:
  apks/
    launchers/    {Launcher} Revya TV.apk   (launcher próprio, padrão do modo TV)
...
task lnch-revya — é o que dispara a reinstalação com -r.
